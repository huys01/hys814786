...
create_clock -period 3.333 -name DAC1_REF_CLKP [get_ports DAC1_REF_CLKP]
create_clock -period 3.333 -name DAC2_REF_CLKP [get_ports DAC2_REF_CLKP]
...
set_clock_groups -asynchronous -group [get_clocks CLK_50M] -group [get_clocks -include_generated_clocks DAC2_REF_CLKP]
...
set_input_delay -clock DAC1_REF_CLKP -max 0.4 [get_ports {DAC_204_IF0\.SYSREF*}]
set_input_delay -clock DAC1_REF_CLKP -min -0.4 [get_ports {DAC_204_IF0\.SYSREF*}]
set_input_delay -clock DAC1_REF_CLKP -max 0.4 [get_ports {DAC_204_IF1\.SYSREF*}]
set_input_delay -clock DAC1_REF_CLKP -min -0.4 [get_ports {DAC_204_IF1\.SYSREF*}]
set_input_delay -clock DAC1_REF_CLKP -max 0.4 [get_ports {DAC_204_IF2\.SYSREF*}]
set_input_delay -clock DAC1_REF_CLKP -min -0.4 [get_ports {DAC_204_IF2\.SYSREF*}]
set_input_delay -clock DAC1_REF_CLKP -max 0.4 [get_ports {DAC_204_IF3\.SYSREF*}]
set_input_delay -clock DAC1_REF_CLKP -min -0.4 [get_ports {DAC_204_IF3\.SYSREF*}]