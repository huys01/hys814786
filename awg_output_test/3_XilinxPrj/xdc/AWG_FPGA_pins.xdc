...
set_property PACKAGE_PIN AH9  [get_ports DAC1_REF_CLKN]
set_property PACKAGE_PIN AH10 [get_ports DAC1_REF_CLKP]
set_property PACKAGE_PIN AM9  [get_ports DAC2_REF_CLKN]
set_property PACKAGE_PIN AM10 [get_ports DAC2_REF_CLKP]
...
#Bank-65
set_property PACKAGE_PIN AD13 [get_ports ADC_PWR_EN]
set_property IOSTANDARD LVCMOS33 [get_ports ADC_PWR_EN]

set_property PACKAGE_PIN AE15 [get_ports PWR_EN_ADC1]
set_property PACKAGE_PIN AE12 [get_ports PWR_EN_ADC2]
set_property PACKAGE_PIN AF12 [get_ports PWR_EN_ADC3]
set_property PACKAGE_PIN AF14 [get_ports PWR_EN_ADC4]
set_property IOSTANDARD LVCMOS33 [get_ports PWR_EN_ADC*]
...
set_property PACKAGE_PIN AK13 [get_ports TEMP_DQ_O]
...
#Bank-65
set_property PACKAGE_PIN AW16 [get_ports ADC1_LED]
set_property PACKAGE_PIN AW15 [get_ports ADC2_LED]
set_property PACKAGE_PIN AV14 [get_ports ADC3_LED]
set_property PACKAGE_PIN AW14 [get_ports ADC4_LED]
set_property PACKAGE_PIN AT13 [get_ports ALERT_LED]
set_property IOSTANDARD LVCMOS33 [get_ports *LED*]

################################################################################
## DAC-AD9173-0 Interface
set_property PACKAGE_PIN AE26 [get_ports {DAC_CFG_IF0\.CSn}]
set_property PACKAGE_PIN AH27 [get_ports {DAC_CFG_IF0\.RESETn}]
set_property PACKAGE_PIN AJ25 [get_ports {DAC_CFG_IF0\.SCLK}]
set_property PACKAGE_PIN AE25 [get_ports {DAC_CFG_IF0\.SDI}]
set_property PACKAGE_PIN AG24 [get_ports {DAC_CFG_IF0\.SDO}]
set_property PACKAGE_PIN AF27 [get_ports {DAC_CFG_IF0\.TXENABLE}]

set_property PACKAGE_PIN AG8 [get_ports {DAC_204_IF0\.TX_P[0]}]
set_property PACKAGE_PIN AG7 [get_ports {DAC_204_IF0\.TX_N[0]}]
set_property PACKAGE_PIN AF6 [get_ports {DAC_204_IF0\.TX_P[1]}]
set_property PACKAGE_PIN AF5 [get_ports {DAC_204_IF0\.TX_N[1]}]
set_property PACKAGE_PIN AE4 [get_ports {DAC_204_IF0\.TX_P[2]}]
set_property PACKAGE_PIN AE3 [get_ports {DAC_204_IF0\.TX_N[2]}]
set_property PACKAGE_PIN AD6 [get_ports {DAC_204_IF0\.TX_P[3]}]
set_property PACKAGE_PIN AD5 [get_ports {DAC_204_IF0\.TX_N[3]}]
set_property PACKAGE_PIN AL24 [get_ports {DAC_204_IF0\.SYNC_P}]
set_property PACKAGE_PIN AL25 [get_ports {DAC_204_IF0\.SYNC_N}]
set_property PACKAGE_PIN AK27 [get_ports {DAC_204_IF0\.SYSREF_P}]
set_property PACKAGE_PIN AK28 [get_ports {DAC_204_IF0\.SYSREF_N}]


## DAC-AD9173-1 Interface
set_property PACKAGE_PIN AF22 [get_ports {DAC_CFG_IF1\.CSn}]
set_property PACKAGE_PIN AE22 [get_ports {DAC_CFG_IF1\.RESETn}]
set_property PACKAGE_PIN AG22 [get_ports {DAC_CFG_IF1\.SCLK}]
set_property PACKAGE_PIN AE21 [get_ports {DAC_CFG_IF1\.SDI}]
set_property PACKAGE_PIN AH21 [get_ports {DAC_CFG_IF1\.SDO}]
set_property PACKAGE_PIN AF23 [get_ports {DAC_CFG_IF1\.TXENABLE}]
...
set_property PACKAGE_PIN AJ20 [get_ports {DAC_204_IF1\.SYNC_P}]
set_property PACKAGE_PIN AJ21 [get_ports {DAC_204_IF1\.SYNC_N}]
set_property PACKAGE_PIN AK23 [get_ports {DAC_204_IF1\.SYSREF_P}]
set_property PACKAGE_PIN AL23 [get_ports {DAC_204_IF1\.SYSREF_N}]


## DAC-AD9173-2 Interface
set_property PACKAGE_PIN AR22 [get_ports {DAC_CFG_IF2\.CSn}]
set_property PACKAGE_PIN AP21 [get_ports {DAC_CFG_IF2\.RESETn}]
set_property PACKAGE_PIN AR21 [get_ports {DAC_CFG_IF2\.SCLK}]
set_property PACKAGE_PIN AR23 [get_ports {DAC_CFG_IF2\.SDI}]
set_property PACKAGE_PIN AT22 [get_ports {DAC_CFG_IF2\.SDO}]
set_property PACKAGE_PIN AP23 [get_ports {DAC_CFG_IF2\.TXENABLE}]
set_property PACKAGE_PIN AR8 [get_ports {DAC_204_IF2\.TX_P[0]}]
set_property PACKAGE_PIN AR7 [get_ports {DAC_204_IF2\.TX_N[0]}]
set_property PACKAGE_PIN AP6 [get_ports {DAC_204_IF2\.TX_P[1]}]
set_property PACKAGE_PIN AP5 [get_ports {DAC_204_IF2\.TX_N[1]}]
set_property PACKAGE_PIN AN8 [get_ports {DAC_204_IF2\.TX_P[2]}]
set_property PACKAGE_PIN AN7 [get_ports {DAC_204_IF2\.TX_N[2]}]
set_property PACKAGE_PIN AM6 [get_ports {DAC_204_IF2\.TX_P[3]}]
set_property PACKAGE_PIN AM5 [get_ports {DAC_204_IF2\.TX_N[3]}]
set_property PACKAGE_PIN AU21 [get_ports {DAC_204_IF2\.SYNC_P}]
set_property PACKAGE_PIN AV22 [get_ports {DAC_204_IF2\.SYNC_N}]
set_property PACKAGE_PIN AV23 [get_ports {DAC_204_IF2\.SYSREF_P}]
set_property PACKAGE_PIN AW23 [get_ports {DAC_204_IF2\.SYSREF_N}]

## DAC-AD9173-3 Interface
set_property PACKAGE_PIN AP26 [get_ports {DAC_CFG_IF3\.CSn}]
set_property PACKAGE_PIN AP25 [get_ports {DAC_CFG_IF3\.RESETn}]
set_property PACKAGE_PIN AR28 [get_ports {DAC_CFG_IF3\.SCLK}]
set_property PACKAGE_PIN AT28 [get_ports {DAC_CFG_IF3\.SDI}]
set_property PACKAGE_PIN AT27 [get_ports {DAC_CFG_IF3\.SDO}]
set_property PACKAGE_PIN AM24 [get_ports {DAC_CFG_IF3\.TXENABLE}]
set_property PACKAGE_PIN  AW8 [get_ports {DAC_204_IF3\.TX_P[0]}]
set_property PACKAGE_PIN  AW7 [get_ports {DAC_204_IF3\.TX_N[0]}]
set_property PACKAGE_PIN  AV6 [get_ports {DAC_204_IF3\.TX_P[1]}]
set_property PACKAGE_PIN  AV5 [get_ports {DAC_204_IF3\.TX_N[1]}]
set_property PACKAGE_PIN  AU8 [get_ports {DAC_204_IF3\.TX_P[2]}]
set_property PACKAGE_PIN  AU7 [get_ports {DAC_204_IF3\.TX_N[2]}]
set_property PACKAGE_PIN  AT6 [get_ports {DAC_204_IF3\.TX_P[3]}]
set_property PACKAGE_PIN  AT5 [get_ports {DAC_204_IF3\.TX_N[3]}]
set_property PACKAGE_PIN AV26 [get_ports {DAC_204_IF3\.SYNC_P}]
set_property PACKAGE_PIN AV27 [get_ports {DAC_204_IF3\.SYNC_N}]
set_property PACKAGE_PIN AR26 [get_ports {DAC_204_IF3\.SYSREF_P}]
set_property PACKAGE_PIN AR27 [get_ports {DAC_204_IF3\.SYSREF_N}]
...
set_property IOSTANDARD LVDS [get_ports {DAC_204_IF*\.SYSREF_N}]
set_property IOSTANDARD LVDS [get_ports {DAC_204_IF*\.SYSREF_P}]
